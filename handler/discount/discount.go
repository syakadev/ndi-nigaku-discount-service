...
func NewDiscountHandler(
	...
	rStrict.Get("/:id", handler.GetDiscountByID)
	rStrict.Post("/", handler.CreateDiscount)
	rStrict.Put("/:id", handler.UpdateDiscount)
	rStrict.Delete("/:id", handler.DeleteDiscount)
}
