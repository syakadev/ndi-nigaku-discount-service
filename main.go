...
import (
	...
	handlers "template/service/auth/handler/auth"
	"template/service/auth/handler/configs"
	"template/service/auth/handler/http_util"
	_deliveryMiddleware "template/service/auth/handler/middleware"
	...
	_ "template/service/auth/docs" // load API Docs files (Swagger)
)
